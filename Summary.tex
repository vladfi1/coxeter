...
%define main problem or objective (a bit vague so that exact subject is not revealed)
%"we extend a property proved by xxx thesis..."
%approach / methods (including program)
%summary of main proven results/ properties
%next steps
